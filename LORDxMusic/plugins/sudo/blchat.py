...
from LORDxMusic.misc import SUDOERS
from LORDxMusic.utils.database import blacklist_chat, blacklisted_chats, whitelist_chat
from LORDxMusic.utils.decorators.language import language
from config import BANNED_USERS


@app.on_message(filters.command(["حظر مجموعة", "حظر مجموعه"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["المجموعات المحظورة", "المجموعات المحظوره"]) & ~BANNED_USERS)
@language
