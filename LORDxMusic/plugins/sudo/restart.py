...
from LORDxMusic.misc import HAPP, SUDOERS, XCB
...
@app.on_message(filters.command(["اعاده لورد"]) & SUDOERS)
async def restart_(_, message):
    ...
    for x in ac_chats:
        try:
            await app.send_message(
                chat_id=int(x),
                text=f"» جـارِ اعـادة تشغيـل البـوت ...\n» انتظـر عـدة دقـائـق ⏳\n» حتـى يعمـل البـوت ☑️...",
            )
            await remove_active_chat(x)
            await remove_active_video_chat(x)
        except:
