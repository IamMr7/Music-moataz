...
from LORDxMusic.utils.database import add_gban_user, remove_gban_user
from LORDxMusic.utils.decorators.language import language
from LORDxMusic.utils.extraction import extract_user
...
@app.on_message(filters.command(["البلوك", "blockedusers", "المبلكين"]) & SUDOERS)
@language
