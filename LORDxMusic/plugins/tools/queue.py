...
from LORDxMusic.utils import LORDyBin, get_channeplayCB, seconds_to_min
from LORDxMusic.utils.database import get_cmode, is_active_chat, is_music_playing
from LORDxMusic.utils.decorators.language import language, languageCB
from LORDxMusic.utils.inline import queue_back_markup, queue_markup
...
@app.on_message(
    filters.command(["/queue", "اونلاين", "queue", "/الاغاني", "/اونلاين", "الاغاني"])
    & filters.group
    & ~BANNED_USERS
)
@language
