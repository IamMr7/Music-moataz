...
from LORDxMusic.utils.formatters import time_to_seconds
...
def track_markup(_, videoid, user_id, channel, fplay):
    buttons = [
        ...
        [InlineKeyboardButton(text=_["LORD_BUTTON"], url=f"https://t.me/S_O_M_A44")],
        [
            InlineKeyboardButton(
                text=_["CLOSE_BUTTON"],
...
def stream_markup_timer(_, chat_id, played, dur):
    ...
    buttons = [
        ...
        [InlineKeyboardButton(text=_["LORD_BUTTON"], url=f"https://t.me/S_O_M_A44"),
        InlineKeyboardButton(text=_["LORD_BUTTON2"], url=f"https://t.me/M2RR1")],
...
def playlist_markup(_, videoid, user_id, ptype, channel, fplay):
    buttons = [
        [
            InlineKeyboardButton(
                text=_["P_B_1"],
                callback_data=f"LORDyPlaylists {videoid}|{user_id}|{ptype}|a|{channel}|{fplay}",
            ),
            InlineKeyboardButton(
                text=_["P_B_2"],
                callback_data=f"LORDyPlaylists {videoid}|{user_id}|{ptype}|v|{channel}|{fplay}",
            ),
        ],
        [InlineKeyboardButton(text=_["LORD_BUTTON"], url=f"https://t.me/S_O_M_A44")],
        [
