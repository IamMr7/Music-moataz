...
async def get_thumb(videoid):
    try:
        ...
        if 1 == 1:
            ...
            circle = Image.open("LORDxMusic/assets/LORD.png")
            ...
            # fonts
            font1 = ImageFont.truetype("LORDxMusic/assets/font2.ttf", 30)
            font2 = ImageFont.truetype("LORDxMusic/assets/font2.ttf", 70)
            font3 = ImageFont.truetype("LORDxMusic/assets/font2.ttf", 40)
            font4 = ImageFont.truetype("LORDxMusic/assets/font2.ttf", 35)
